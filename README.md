...
Then can be defined as $T(n)=\frac{n}{2}$ if $n \equiv 0 \pmod{2}$, or $3n+1$ if $n\equiv 1 \pmod{2}$,
<p/>
...
<p/>
The Collatz conjecture is stating that $min(T^{(k)}(n))=1$ for $n\geq2$, in other words, $S(n)$ is finite.
